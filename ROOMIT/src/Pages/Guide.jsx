    ...
    <div className="guide-container">
      ...
      <div className="guide-content">
        <div className="guide-timeline">
          ...
          <div className="guide-step" onClick={() => toggleSection('matching')}>
            <div className="step-number">1</div>
            <div className="step-content">
              <div className="step-header">
                <h2>🤝 매칭 단계</h2>
                <span className="expand-icon">{activeSection === 'matching' ? '−' : '+'}</span>
              </div>
              <div className={`step-details ${activeSection === 'matching' ? 'active' : ''}`}>
          ...
          <div className="guide-step" onClick={() => toggleSection('housing')}>
            <div className="step-number">2</div>
            <div className="step-content">
              <div className="step-header">
                <h2>🏡 주거지 탐색</h2>
                <span className="expand-icon">{activeSection === 'housing' ? '−' : '+'}</span>
              </div>
              <div className={`step-details ${activeSection === 'housing' ? 'active' : ''}`}>
                <div className="detail-card">
                  <div className="card-icon">📍</div>
                  <div className="card-content">
                    <h3>맞춤 집 추천</h3>
          ...
          <div className="guide-step" onClick={() => toggleSection('contract')}>
            <div className="step-number">3</div>
            <div className="step-content">
              <div className="step-header">
                <h2>📄 계약 가이드</h2>
                <span className="expand-icon">{activeSection === 'contract' ? '−' : '+'}</span>
              </div>
              <div className={`step-details ${activeSection === 'contract' ? 'active' : ''}`}>
...
룸메이트2 서명: ________________    날짜: ________`}
          ...
          <div className="guide-step" onClick={() => toggleSection('dispute')}>
            <div className="step-number">4</div>
            <div className="step-content">
              <div className="step-header">
                <h2>⚖️ 분쟁 해결</h2>
                <span className="expand-icon">{activeSection === 'dispute' ? '−' : '+'}</span>
              </div>
              <div className={`step-details ${activeSection === 'dispute' ? 'active' : ''}`}>
                <div className="dispute-resolution">
                  <div className="resolution-step">
                    <div className="resolution-icon">💬</div>
                    <div className="resolution-content">
                      <h4>1단계: 대화를 통한 해결</h4>
                      <p>집 파손과 같은 문제는 사용자 간 충분한 대화를 통해 합의를 시도합니다.</p>
                    </div>
                  </div>
                  <div className="resolution-step">
                    <div className="resolution-icon">🤝</div>
                    <div className="resolution-content">
                      <h4>2단계: 플랫폼 중재</h4>
                      <p>필요시 플랫폼에서 가이드 및 중재 기능을 제공할 예정입니다.</p>
                    </div>
                  </div>
                  <div className="resolution-step">
                    ...
                    <div className="resolution-content">
                      <h4>3단계: 전문기관 상담</h4>
                      <p>심각한 분쟁의 경우 관련 전문기관을 통한 해결을 권장합니다.</p>
                    </div>
                  </div>
                </div>
